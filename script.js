...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function positionNebulaButtons() {
        ...
        const radiusX = Math.min(heroContent.offsetWidth / 2 + 120, 300);
        const radiusY = Math.min(heroContent.offsetHeight / 2 + 80, 250);
        ...
        projects.forEach((project, index) => {
            ...
            button.className = `nebula-button nebula-${index + 1}`;
